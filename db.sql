...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-04-2025 a las 14:32:18
...
--
CREATE DATABASE IF NOT EXISTS `chacinados` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `chacinados`;
...
--
CREATE DATABASE IF NOT EXISTS `distrubuidora` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `distrubuidora`;
...
('root', '[{\"db\":\"distrubuidora\",\"table\":\"usuario\"},{\"db\":\"distrubuidora\",\"table\":\"categoria\"},{\"db\":\"distrubuidora\",\"table\":\"comprador\"},{\"db\":\"distrubuidora\",\"table\":\"empresa\"},{\"db\":\"distrubuidora\",\"table\":\"categorias\"},{\"db\":\"distrubuidora\",\"table\":\"tipo_de_compra\"}]');
...
('root', 'distrubuidora', 'comprador', '{\"sorted_col\":\"`comprador`.`tipo_de_compra` ASC\"}', '2024-11-26 22:36:02');
...
('root', '2025-01-14 13:49:00', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":180}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Base de datos: `proyecto_marcos`
--
CREATE DATABASE IF NOT EXISTS `proyecto_marcos` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `proyecto_marcos`;
...
INSERT INTO `pago` (`id`, `Monto_pago`, `Pagado`) VALUES
(1, 2000, 1);
